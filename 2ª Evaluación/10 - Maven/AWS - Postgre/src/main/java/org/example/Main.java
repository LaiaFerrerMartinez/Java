...
public class Main {
    ...
    public static final String URLPostgre = "jdbc:postgresql://netflix.c3smyaeku6nl.us-east-1.rds.amazonaws.com/postgres";
    public static final String USERPostgre = "postgres";
    public static final String PASSPostgre = "123456789";
